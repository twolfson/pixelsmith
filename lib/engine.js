...
function Pixelsmith(options) {
  options = options || {};
  this.concurrentFileLimit = options.concurrentFileLimit || Infinity;
}
...
Pixelsmith.prototype = {
  ...
  createImages: function (files, callback) {
    ...
    // DEV: We use `mapLimit` to deal with file descriptor constraints, https://github.com/twolfson/pixelsmith/issues/20
    async.mapLimit(files, this.concurrentFileLimit, this.createImage.bind(this), callback);
  }
};
