...
var supportedExtensions = ['jpeg', 'png', 'gif'];
 ...
 */
function exportCanvas(ext, options, cb) {
  // Determine the export extension
  assert(supportedExtensions.indexOf(ext) !== -1,
    '`pixelsmith` doesn\'t support exporting "' + ext + '". Please use "jpeg", "png", or "gif"');
